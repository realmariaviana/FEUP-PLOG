...
% Checks the first element in a column/line and if it is a players piece, checks if the second one is empty or not
...
% Checks the last element in a column/line and if it is a players piece, checks if the second to last one is empty or not
check_last_element(Line) :-
